...
const MainDashBoard = () => {
    const defaultDataSensors = [
        { temp: 20, humi: 20, light: 2000, windSpeed: 70, time: '20:20:20' },
        { temp: 25, humi: 24, light: 2430, windSpeed: 50, time: '20:20:20' },
        { temp: 34, humi: 25, light: 2230, windSpeed: 60, time: '20:20:20' },
        { temp: 55, humi: 20, light: 2870, windSpeed: 10, time: '20:20:20' },
        { temp: 43, humi: 28, light: 2098, windSpeed: 25, time: '20:20:20' },
        { temp: 25, humi: 40, light: 2910, windSpeed: 39, time: '20:20:20' },
        { temp: 22, humi: 50, light: 1108, windSpeed: 10, time: '20:20:20' },
        { temp: 36, humi: 23, light: 2002, windSpeed: 30, time: '20:20:20' },
        { temp: 37, humi: 18, light: 3006, windSpeed: 40, time: '20:20:20' },
        { temp: 28, humi: 80, light: 1129, windSpeed: 50, time: '20:20:20' }
    ];
    ...
    const generateRandomData = () => {
        return {
            ...
            humi: Math.floor(Math.random() * 100),
            light: Math.floor(Math.random() * 4096),
            windSpeed: Math.floor(Math.random() * 101),
            time: getCurrentTime()
        };
    };
    ...
    //                 humi: dataSensor.humidity,
    //                 light: dataSensor.light,
    //                 windSpeed: dataSensor.randomSensor,
    //                 time: dataSensorTime,
    //             }; // Assuming you have a function to generate random data
    //             newData.push(newEntry);
