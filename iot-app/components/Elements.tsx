...
//                         <IoSunnyOutline />
//                     </div>
//                     <div className={`py-[10px] px-[20px] flex-1 font-poppin ${values.light > 2000 ? '-' : ''}`}>
...
const Elements = ({ values }: IValueV1Props) => {
    ...
    useEffect(() => {
        ...
        if (bgSensorRef.current) {
            const sensor = values.windSpeed;
            bgSensorRef.current.style.width = `${sensor}%`;
        ...
        <>
            ...
            <div className="flex justify-between mb-[30px]">
                ...
                <div className="card-v1">
                    ...
                    <div className={`py-[10px] px-[20px] flex-1 font-poppin ${values.windSpeed >= 70 ? 'alertSensor' : ''}`}>
                        <div className="card-title">Wind Speed</div>
                        <div className="flex items-center">
                            <span className="w-[80px] text-center text-[18px] leading-[1]">{values.windSpeed} {"M/S"}</span>
                            <div className="flex-1 ml-[15px] rounded-[30px] bg-gray-300 h-[15px] overflow-hidden">
